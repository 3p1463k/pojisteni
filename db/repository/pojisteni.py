...
from schemas.pojisteni import VytvorPojisteni, ZobrazPojisteni, UpravPojisteni
from db.models.pojisteni import Pojisteni


def vytvor_nove_pojisteni(
